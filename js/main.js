  ...
  return _createClass(main, [{
        ...
        if (thisSwiper.classList.contains('gallery-slider')) {
          on = {
            slideChange: function slideChange(e) {
              ...
              for (var _i4 = 0; _i4 < _this2.galleryIndex.length; _i4++) {
                var gallery = _this2.galleryIndex[_i4];
              ...
              document.getElementsByClassName("gallery-index".concat(activeIndex))[0].classList.add('up');
            }
          };
          if (this.width < 750) {
            excute = false;
    ...
    value: function triggerMenu(e) {
      ...
      if (this.menu.classList.contains('active')) {
        ...
        for (var _i5 = 0; _i5 < this.menuTrigger.length; _i5++) {
          this.menuTrigger[_i5].classList.add('active');
        }
      }
    }
  }, {
    ...
    value: function lenis() {
      ...
      if (this.lenisInstance) {
        gsap.ticker.add(function (time) {
          _this3.lenisInstance.raf(time * 1000);
        });
      }
    }
  }]);
